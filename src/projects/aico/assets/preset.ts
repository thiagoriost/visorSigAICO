...
export const Preset = definePreset(Nora, {
  ...
  semantic: {
    ...
    primary: {
      ...
      200: '#E4E4E4',
      300: '#3D1B11', // Bordes
      400: '#c33f25', // medio puro - Botones
      500: '#FFFFFF', // principal #214829   03577E
      600: '#d66048', // #1c3d23 #1B6487
      700: '#c33f25',
      800: '#209A54',
      900: '#50B969',
      950: '#209A54',
    ...
    colorScheme: {
      light: {
        surface: {
          ...
          300: '#e3e4de',
          400: '#dbdbd3',
          500: '#03577E', // Secundario
          600: '#C33F25',
          700: '#D66048', // Secundario version 2
          800: '#74746f',
          900: '#545450',
          950: '#353532',
        },
        ...
        highlight: {
          background: '#ffffff', // Selección mouse
        ...
        text: {
          ...
          hoverColor: '{surface.0}', // Color al hacer hover
