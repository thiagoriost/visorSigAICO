...
import { IndexPageComponent } from '../cric/pages/index/index-page/index-page.component';
import { appConfig } from './cric.config';
import { WIDGET_CONFIG } from '@app/core/config/interfaces/IWidgetConfig';
import { CRIC_WIDGET_CONFIG } from './files/widget.config';
...
async function main() {
  ...
  return bootstrapApplication(IndexPageComponent, {
    ...
    providers: [
      ...
      { provide: WIDGET_CONFIG, useValue: CRIC_WIDGET_CONFIG },
    ],
  });
}
