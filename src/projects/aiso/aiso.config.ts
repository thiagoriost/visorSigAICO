...
import { Preset } from '@projects/aiso/assets/preset';
import { swipeReducer } from '@app/widget/swipe/store/swipe.reducer';
import { routes } from './aiso.routes';

/**
 * @fileoverview
 * Configuración principal de la aplicación AISO.
 * Define los proveedores globales de Angular, NgRx y PrimeNG,
 * incluyendo enrutamiento, manejo del estado, animaciones y tema visual.
