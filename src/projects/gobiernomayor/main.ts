...
import { IndexPageComponent } from '../gobiernomayor/pages/index/index-page/index-page.component';
import { appConfig } from './gobiernomayor.config';
import { WIDGET_CONFIG } from '@app/core/config/interfaces/IWidgetConfig';
import { GOBIERNO_MAYOR_WIDGET_CONFIG } from './files/widget.config';
...
async function main() {
  ...
  return bootstrapApplication(IndexPageComponent, {
    ...
    providers: [
      ...
      { provide: WIDGET_CONFIG, useValue: GOBIERNO_MAYOR_WIDGET_CONFIG },
    ],
  });
}
