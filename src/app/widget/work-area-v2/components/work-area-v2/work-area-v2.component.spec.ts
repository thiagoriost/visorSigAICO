...
import { WorkAreaV2Component } from './work-area-v2.component';
...
describe('WorkAreaV2Component', () => {
  let component: WorkAreaV2Component;
  let fixture: ComponentFixture<WorkAreaV2Component>;
  let store: MockStore;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [WorkAreaV2Component, StoreModule.forRoot({})],
      providers: [provideMockStore()],
    }).compileComponents();

    fixture = TestBed.createComponent(WorkAreaV2Component);
  ...
  it('debería renderizar la cantidad correcta de layer components', () => {
    ...
    const layerElements = fixture.debugElement.queryAll(
      By.css('app-work-layer-item')
    );
